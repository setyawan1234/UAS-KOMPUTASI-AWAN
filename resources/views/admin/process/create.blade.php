...
@section('title'){{'Create Process'}} @endsection
@section('content')
<div class="container-fluid pt-4 px-4">
    <div class="row g-4">
        <div class="col-sm-12 col-xl-12">
            <div class="bg-light rounded h-100 p-4">
                <h6 class="mb-4">Tambah Process</h6>
                @if (count($errors) > 0)
                ...
                @endif
                <form method="post" action="/adminprocess" id="myForm" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <a class="btn btn-success " href="/adminprocess">Kembali</a>
                </form>
            </div>
        </div>
    </div>
